          ...
          child: Column(
            ...
            children: [
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: isClickbait
                        ...
                        : [Colors.green.shade900, Colors.tealAccent],
                  ),
                  borderRadius: BorderRadius.circular(20),
                  boxShadow: [
                    BoxShadow(
                      color: isClickbait ? Colors.red.withOpacity(0.5) : Colors.green.withOpacity(0.5),
                      blurRadius: 30,
                      spreadRadius: 10,
                    )
                  ],
              ...
              ElevatedButton(
                ...
                child: const Text("SCAN ANOTHER", style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
